...
// import { CombinedWears, MenWears, WomenWears } from "../constants/content";
...
//                     {/* {formatCurrency(item.formerPrice, "NGN")} */}
...
//                     fillRule="evenodd"
//                     clipRule="evenodd"
//                     d="M19.0938 28.8438C21.5098 28.8438 23.5 30.834 23.5 33.2501C23.5 35.6661 21.5098 37.6563 19.0938 37.6563C16.6777 37.6563 14.6875 35.6661 14.6875 33.2501C14.6875 30.834 16.6777 28.8438 19.0938 28.8438ZM19.0938 31.7813C18.2683 31.7813 17.625 32.4246 17.625 33.2501C17.625 34.0755 18.2683 34.7188 19.0938 34.7188C19.9192 34.7188 20.5625 34.0755 20.5625 33.2501C20.5625 32.4246 19.9192 31.7813 19.0938 31.7813ZM32.3125 28.8438C34.7286 28.8438 36.7188 30.834 36.7188 33.2501C36.7188 35.6661 34.7286 37.6563 32.3125 37.6563C29.8965 37.6563 27.9062 35.6661 27.9062 33.2501C27.9062 30.834 29.8965 28.8438 32.3125 28.8438ZM32.3125 31.7813C31.487 31.7813 30.8438 32.4246 30.8438 33.2501C30.8438 34.0755 31.4856 34.7188 32.3125 34.7188C33.1379 34.7188 33.7812 34.077 33.7812 33.2501C33.7812 32.4246 33.1394 31.7813 32.3125 31.7813C31.487 31.7813 30.8438 32.4231 30.8438 33.2501C30.8438 34.0755 31.4856 34.7188 32.3125 34.7188C33.1379 34.7188 33.7812 34.077 33.7812 33.2501Z"
//                     fill="#002733"
//                     fillOpacity="0.6"
//                   />
//                 </svg>
...
// import { useState } from "react";
// import { MenWears, WomenWears } from "../constants/content"; // Importing MenWears and WomenWears arrays
// import { useNavigate } from "react-router-dom";
...
//   const CombinedWears = [...MenWears, ...WomenWears]; // Combining MenWears and WomenWears into a single array
