                  ...
                  <div className="price flex gap-2">
                    <div className="gap-2 line-through  text-gray-300">
                      <span className="relative inline-block text-gray-300">
                        <span className="line-through absolute top-1/3 left-0 right-0 h-0.5 bg-gray-300"></span>
                        <span className="line-through absolute top-1/2 left-0 right-0 h-0.5 bg-gray-300"></span>
                        N
                      </span>
                    ...
                    <div className="currentPrice">
                      <span className="relative inline-block">
                        <span className="line-through absolute top-1/3 left-0 right-0 h-0.5 bg-black"></span>
                        <span className="line-through absolute top-1/2 left-0 right-0 h-0.5 bg-black"></span>
                        N
                      </span>
                      {item.formerPrice * (1 - item.discount / 100)}
                    </div>
                  </div>
                </div>
    ...
    <div className="w-full flex flex-col justify-center items-center mt-12">
      <div className="tabs flex justify-center mb-4">
        <button
          ...
          className="px-4 py-2 mx-2 bg-custom-blue text-white rounded"
        >
          All
        </button>
        <button
