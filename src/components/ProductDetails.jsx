    ...
    <div className="flex flex-col">
      ...
      <div className="px-16 ml-12 mt-4 gap-4 justify-center">
        ...
        {/* <div className="w-full flex flex-wrap justify-center items-center mt-12 sm:w-[1252px]">
          <div className="card m-4 relative cursor-pointer">
            <img
              src="/Users/philemonokpokpa/Desktop/GOMYCODE/t3/timbu/frontend/public/assets/products/men/green.png"
              alt=""
              className="w-60 h-80 object-cover"
            />
            <div className=" wishButton absolute top-2 right-2">
              <svg
                width="20"
                height="19"
                viewBox="0 0 20 19"
            ...
            <div className="product-info relative bottom-[-8] border-l pl-2 flex justify-between items-center">
              <div className="leftOfCard">
                ...
                <div className="price flex gap-2">
                  <div className="gap-2 line-through  text-gray-300"></div>
